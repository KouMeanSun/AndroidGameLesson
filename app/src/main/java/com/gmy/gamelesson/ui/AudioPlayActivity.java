    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AudioPlayActivity.this, "播放音效1", Toast.LENGTH_SHORT).show();
            }});
        b1Pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sp.pause(spMap.get(1));
                Toast.makeText(AudioPlayActivity.this, "暂停音效1", Toast.LENGTH_SHORT).show();
            }});
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playSound(2,1);		//播放第二首音效，循环一遍
                Toast.makeText(AudioPlayActivity.this, "播放音效2", Toast.LENGTH_SHORT).show();
            }});
        b2Pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sp.pause(spMap.get(2));
                Toast.makeText(AudioPlayActivity.this, "暂停音效2", Toast.LENGTH_SHORT).show();
            }});
    }
