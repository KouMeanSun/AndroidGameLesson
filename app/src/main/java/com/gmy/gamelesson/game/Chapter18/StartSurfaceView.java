...
implements SurfaceHolder.Callback {
	...
	{ 
		background=BitmapFactory.decodeResource(getResources(), R.mipmap.startbj);//初始化背景
		ksmsShort=BitmapFactory.decodeResource(getResources(), R.mipmap.ksms);//快速模式
		gameOptionShort=BitmapFactory.decodeResource(getResources(), R.mipmap.option);//设置
		gameExitShort=BitmapFactory.decodeResource(getResources(), R.mipmap.exit);//退出
		gameAboutShort=BitmapFactory.decodeResource(getResources(), R.mipmap.about);//关于
		gameHelpShort=BitmapFactory.decodeResource(getResources(), R.mipmap.help);//帮助
		
		ksmsLong=BitmapFactory.decodeResource(getResources(), R.mipmap.long_ksms);//快速模式
		gameOptionLong=BitmapFactory.decodeResource(getResources(), R.mipmap.long_option);//设置
		gameExitLong=BitmapFactory.decodeResource(getResources(), R.mipmap.long_exit);//退出
		gameAboutLong=BitmapFactory.decodeResource(getResources(), R.mipmap.long_about);//关于
		gameHelpLong=BitmapFactory.decodeResource(getResources(), R.mipmap.long_help);//帮助
	}
	...
	@Override
	public void draw(Canvas canvas)//重绘
	{
		super.draw(canvas);
