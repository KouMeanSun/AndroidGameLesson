...
public class BallCloud 
{
    ...
    public BallCloud(float scale,int texId) 
    {
        ...
        for(float vAngle=90;vAngle>-90;vAngle=vAngle-angleSpan)//垂直方向angleSpan度一份
        {
        	for(float hAngle=360;hAngle>0;hAngle=hAngle-angleSpan)//水平方向angleSpan度一份
        	{
        		...
        		double xozLength=r*scale*UNIT_SIZE*Math.cos(Math.toRadians(vAngle));
        		int x1=(int)(xozLength*Math.cos(Math.toRadians(hAngle)));
        		int z1=(int)(xozLength*Math.sin(Math.toRadians(hAngle)));
        		int y1=(int)(r*scale*UNIT_SIZE*Math.sin(Math.toRadians(vAngle)));
        		
        		xozLength=r*scale*UNIT_SIZE*Math.cos(Math.toRadians(vAngle-angleSpan));
        		int x2=(int)(xozLength*Math.cos(Math.toRadians(hAngle)));
        		int z2=(int)(xozLength*Math.sin(Math.toRadians(hAngle)));
        		int y2=(int)(r*scale*UNIT_SIZE*Math.sin(Math.toRadians(vAngle-angleSpan)));
        		...
        		int y3=(int)(r*scale*UNIT_SIZE*Math.sin(Math.toRadians(vAngle-angleSpan)));
        		
        		xozLength=r*scale*UNIT_SIZE*Math.cos(Math.toRadians(vAngle));
        		...
        		int y4=(int)(r*scale*UNIT_SIZE*Math.sin(Math.toRadians(vAngle)));   
