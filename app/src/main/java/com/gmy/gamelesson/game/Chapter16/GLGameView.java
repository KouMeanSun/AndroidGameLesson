...
public class GLGameView extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            floorTexId=initTexture(gl,R.mipmap.floor);
            sidewallTexId1=initTexture(gl, R.mipmap.swall1);
            sidewallTexId2=initTexture(gl,R.mipmap.swall3);
            backwallTexId=initTexture(gl,R.mipmap.swall2);
            roofTexId=initTexture(gl,R.mipmap.black);
            balltextureid=initTexture(gl,R.mipmap.basketball);
            lzjTextureid=initTexture(gl,R.mipmap.icon);
            lhTextureid=initTexture(gl, R.mipmap.red);
            lbTextureid=initTexture(gl, R.mipmap.lanban2);
            scorebankid=initTexture(gl,R.mipmap.yibiaoban);
            numberid=initTexture(gl,R.mipmap.number);

            shadowid=initTexture(gl,R.mipmap.shadow);
