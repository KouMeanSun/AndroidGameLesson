...
public class FailSurfaceView extends SurfaceView
implements SurfaceHolder.Callback {
	...
	public FailSurfaceView(GL_Demo myActivity) {		
	...
	public void initBitmap(){ 					//初始化图片
		//加载背景图片
		bgAbout=BitmapFactory.decodeResource(getResources(), R.mipmap.failbg);
		//加载返回按钮图片
	...
	@Override
	public void surfaceCreated(SurfaceHolder holder) {	//view创建的时候调用
