...
public class MySurfaceView extends GLSurfaceView {
    ...
    {   
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            iconId=initTexture(gl,R.mipmap.cubesmall);
            headId=initTexture(gl,R.mipmap.head);
            numberId=initTexture(gl,R.mipmap.number);
            cloudId=initTexture(gl,R.mipmap.cloud);
            backId=initTexture(gl,R.mipmap.back);
            levelId=initTexture(gl,R.mipmap.l);
            cube=new Cube
            (
