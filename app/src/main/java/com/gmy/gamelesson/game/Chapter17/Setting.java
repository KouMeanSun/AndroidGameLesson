...
public class Setting extends SurfaceView implements SurfaceHolder.Callback {
	...
	public Setting(MainActivity activity) {
		...
		soundOpen=BitmapFactory.decodeResource(this.getResources(), R.mipmap.soundopen);
		soundClose=BitmapFactory.decodeResource(this.getResources(), R.mipmap.soundclose);
		background=BitmapFactory.decodeResource(this.getResources(), R.mipmap.bground);
