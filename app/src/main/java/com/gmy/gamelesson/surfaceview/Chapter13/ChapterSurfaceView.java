...
public class ChapterSurfaceView  extends GLSurfaceView
{
    float cx=0;//摄像机x位置
    float cy=10;//摄像机y位置
    float cz=30;//摄像机z位置
    ...
    public ChapterSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            cubeTexture=new Cube(cubeTextureId,HEIGHT,LENGTH,WIDTH);//创建纹理长方体
