...
public class CubeIndex2SurfaceView extends GLSurfaceView{
    ...
    float ty=0;//目标点y位置
    float tz=0;//目标点z位置
    public CubeIndex2SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //初始化材质光源
            initMaterial(gl);
            cubeIndex=new CubeIndex2(2.5f,2.5f,2.5f);//创建正方体
            new Thread()
            {
                public void run()
                {
