...
public class BallTextureSurfaceView extends GLSurfaceView {
    ...
    public BallTextureSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            textureId=initTexture(gl, R.mipmap.duke);//初始化纹理
            ball=new BallTexture(4,textureId);
        }
    }
