...
public class MySurfaceView3 extends GLSurfaceView{
    ...
    {
        Diamond diamond;
        TextureRect3 upButton;
        TextureRect3 downButton;
        int upTextureId;
        int downTextureId;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            upTextureId=initTexture(gl, R.mipmap.up);
            downTextureId=initTexture(gl,R.mipmap.down);
            upButton=new TextureRect3(upTextureId);
            downButton=new TextureRect3(downTextureId);
            diamond=new Diamond();
