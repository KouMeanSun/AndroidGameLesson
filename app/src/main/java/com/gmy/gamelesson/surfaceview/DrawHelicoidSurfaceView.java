...
public class DrawHelicoidSurfaceView extends GLSurfaceView {
    ...
    public DrawHelicoidSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        DrawHelicoidSurface cylinder;//创建螺旋面
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            textureId=initTexture(gl, R.mipmap.line2);//纹理ID
            cylinder=new DrawHelicoidSurface(2f,10f,textureId);//创建螺旋面
