...
import static com.gmy.gamelesson.surfaceview.Chapter11.Constant3.*;
...
public class MySurfaceView4 extends GLSurfaceView{
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //初始化纹理
            lqcTexId=initTexture(gl,R.mipmap.mdb);
            basketballTexId=initTexture(gl, R.mipmap.basketball);
            //lqcTMTexId=initTexture(gl,R.drawable.mdbtm);//用来 绘制比较真实的效果
            //创建半透明篮球 板
            //tr=new TextureRect(4,2.568f,lqcTMTexId);//用来 绘制比较真实的效果
            //创建普通不透明篮球板
            trL=new TextureRect2(4,2.568f,lqcTexId);
            //创建用于绘制的球
