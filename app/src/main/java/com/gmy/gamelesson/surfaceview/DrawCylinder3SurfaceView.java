...
public class DrawCylinder3SurfaceView extends GLSurfaceView {
    ...
    public DrawCylinder3SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            textureId=initTexture(gl, R.mipmap.qinghua);//纹理ID
            cylinder=new DrawParaboloid(5f,2f,2f,10,20,textureId);//创建圆柱体
