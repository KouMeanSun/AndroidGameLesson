...
public class Cube2SurfaceView extends GLSurfaceView
{
    ...
    public Cube2SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载纹理
            bigTexId=initTexture(gl, R.mipmap.cubebig);
            smallTexId=initTexture(gl,R.mipmap.cubesmall);
            //创建长方体
            c=new Cube2(1,smallTexId,bigTexId);
            //开启一个线程将长方体绕指定轴旋转
            new Thread()
            {
                public void run()
