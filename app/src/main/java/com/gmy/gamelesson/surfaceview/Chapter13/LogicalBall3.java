...
public class LogicalBall3 {
    ...
    Ball_Go_Thread bgt;
    public LogicalBall3(BallForDraw3 ball,float startX,float vx,float mass)
    {
        this.ball=ball;
        this.mass=mass;
        this.startX=startX;
    ...
    public void move(ArrayList<LogicalBall3> ballAl,float lostAnergy)
    {
        ...
        {
            LogicalBall3 bfcL=ballAl.get(i);
            if(bfcL!=this)
            {
