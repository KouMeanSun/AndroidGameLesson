...
public class DrawCirqueSurfaceView extends GLSurfaceView {
    ...
    public DrawCirqueSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            textureId=initTexture(gl, R.mipmap.stone2);//纹理ID
            cylinder=new DrawCirque(12f,12f,10f,2f,textureId);//创建圆柱体
