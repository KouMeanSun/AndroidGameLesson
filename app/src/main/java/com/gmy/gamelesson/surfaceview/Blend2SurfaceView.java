...
public class Blend2SurfaceView extends GLSurfaceView{
    ...
    public Blend2SurfaceView(Context context) {
        super(context);
    ...
    {
        BallTextureByVertex earth;//地球表面
        BallTextureByVertex moon;//月球表面
        BallTextureByVertex earthCloud;//地球云层
        Celestial3 celestialSmall;//小星星星空半球
        Celestial3 celestialBig;//大星星星空半球
        TextureRect4 halo;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //初始化纹理
            earthTextureId=initTexture(gl,R.mipmap.earth);
            moonTextureId=initTexture(gl, R.mipmap.moon);
            haloTextureId=initTexture(gl,R.mipmap.halo);
            cloudTextureId=initTexture(gl,R.mipmap.clouds);

            //初始化三个球
            earth=new BallTextureByVertex(6000,earthTextureId);
            moon=new BallTextureByVertex(2000,moonTextureId);
            earthCloud=new BallTextureByVertex(6006,cloudTextureId);

            //创建星空
            celestialSmall=new Celestial3(0,0,1,0,750);
            celestialBig=new Celestial3(0,0,2,0,200);

            //创建地球光晕
            halo=new TextureRect4(haloTextureId);
