...
public class BulletForControl {
    MySurfaceView6 mSurfaceView;//声明引用
    Bullet bullet;//声明子弹
    ...
    TextureRect6[] trExplo;//播放爆炸动画的帧
    //爆炸动画是否开始标志
    boolean anmiStart=false;
    //爆炸动画纹理矩形的标志板角度
    float anmiYAngle;
    int anmiIndex=0;//爆炸动画帧索引
    public BulletForControl(MySurfaceView6 mSurfaceView,Bullet bullet,TextureRect6[] trExplo,float xOffset,float yOffset,float zOffset,float vx,float vy,float vz)
    {
