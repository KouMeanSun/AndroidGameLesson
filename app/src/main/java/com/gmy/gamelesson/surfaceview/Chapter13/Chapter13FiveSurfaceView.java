...
public class Chapter13FiveSurfaceView extends GLSurfaceView {
    ...
    public Chapter13FiveSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        Pyramid5 pyramid;//烟火棱锥
        FireWorks5 fw;//焰火粒子系统
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            ptexIdArray[0]=initTexture(gl,R.mipmap.partical_red);
            ptexIdArray[1]=initTexture(gl,R.mipmap.partical_green);
            ptexIdArray[2]=initTexture(gl,R.mipmap.partical_blue);
            ptexIdArray[3]=initTexture(gl,R.mipmap.partical_purple);
            ptexIdArray[4]=initTexture(gl,R.mipmap.partical_yellow);
            ptexIdArray[5]=initTexture(gl,R.mipmap.partical_cyan);

            //创建焰火棱锥
            pyramid=new Pyramid5(0.6f,fuTexId);
            //创建焰火粒子系统
            fw=new FireWorks5(ptexIdArray);
        }
