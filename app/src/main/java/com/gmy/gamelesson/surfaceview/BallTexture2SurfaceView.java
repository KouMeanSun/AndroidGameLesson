...
public class BallTexture2SurfaceView extends GLSurfaceView{
    ...
    public BallTexture2SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            earth=new BallTexture2(6,earthTextureId);
            moon=new BallTexture2(2,moonTextureId);
