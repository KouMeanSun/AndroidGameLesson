...
public class WordSurfaceView extends GLSurfaceView {
    ...
    public WordSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        Desert desert;//沙漠
        Celestial2 celestialSmall;//小星星星空半球
        Celestial2 celestialBig;//大星星星空半球
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //初始化纹理
            wallaId=initTexture(gl, R.mipmap.walla);
            wallbId=initTexture(gl,R.mipmap.wallb);
            wallcId=initTexture(gl,R.mipmap.wallc);
            desertId=initTexture(gl,R.mipmap.desert);
            ...
            //创建星空
            celestialSmall=new Celestial2(0,0,1,0,250);
            celestialBig=new Celestial2(0,0,2,0,50);
