...
public class DrawCircleSurfaceView extends GLSurfaceView {
    ...
    public DrawCircleSurfaceView(Context context) {
        super(context);
    ...
    public class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            bodyTextureId=initTexture(gl,R.mipmap.hong);//纹理ID
            circleTextureId=initTexture(gl, R.mipmap.huang);
            cylinder=new PackageDrum(DrawCircleSurfaceView.this);
//            //开启一个线程自动旋转光源
            new Thread()
            {
          	  public void run()
