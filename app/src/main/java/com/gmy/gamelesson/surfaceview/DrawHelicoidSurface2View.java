...
public class DrawHelicoidSurface2View extends GLSurfaceView {
    private final float TOUCH_SCALE_FACTOR = 180.0f/320;//角度缩放比例
    private SceneRenderer mRenderer;//场景渲染器
    private float mPreviousY;//上次的触控位置Y坐标
    private float mPreviousX;//上次的触控位置Y坐标

    public DrawHelicoidSurface2View(Context context) {
        super(context);
    ...
    {
        DrawHelicoidSurface2 cylinder;//创建螺旋面
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            cylinder=new DrawHelicoidSurface2(2f,10f);//创建螺旋面
