...
public class BlendSurfaceView extends GLSurfaceView{

    private SceneRenderer mRenderer;//场景渲染器

    public BlendSurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        ColorRect2 c1;//颜色矩形1
        ColorRect2 c2;//颜色矩形2
        TextureRect3 t1;//纹理矩形1
        TextureRect3 t2;//纹理矩形2
...
//            gl.glBlendFunc(GL10.GL_ONE, GL10.GL_ONE_MINUS_DST_ALPHA);
            ...
            //初始化纹理
            baseTextureId=initTexture(gl, R.mipmap.base);
            topTextureId=initTexture(gl,R.mipmap.top);

            //创建矩形
            c1=new ColorRect2(one,0,0,one*3/4);
            c2=new ColorRect2(0,one,0,one/2);
            t1=new TextureRect3(baseTextureId);
            t2=new TextureRect3(topTextureId);
        }
    }
