...
public class BallForControl {
    ...
    public BallForControl(MySurfaceView5 mSurfaceView,Ball ball,float xOffset,float yOffset,float zOffset,float vx,float vy,float vz)
    {
