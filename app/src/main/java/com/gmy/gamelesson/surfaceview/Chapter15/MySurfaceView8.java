...
import static com.gmy.gamelesson.surfaceview.Chapter15.Constant8.*;
...
public class MySurfaceView8  extends GLSurfaceView
{
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            cubeTextureId=initTexture(gl, R.mipmap.sky);
            cube=new Cube8(cubeTextureId,HEIGHT,LENGTH,WIDTH);
        }
