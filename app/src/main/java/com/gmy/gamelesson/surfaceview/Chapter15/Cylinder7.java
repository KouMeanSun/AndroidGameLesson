...
import static com.gmy.gamelesson.surfaceview.Chapter15.Constant7.BIGER_FACTER;
...
public class Cylinder7 extends BNShape{
    ...
    float yOffset;
    float zOffset;
    public Cylinder7(int textureId,float length,float circle_radius,float degreespan,int col,float xOffset,float yOffset,float zOffset)
    {
